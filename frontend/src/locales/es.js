...
export default {
  ...
  // --- CrossFit WOD & Metcon ---
  'CrossFit WOD / Metcon & Notes': 'CrossFit WOD / Metcon y Notas',
  'Add WOD details, score & notes': 'Añadir detalles del WOD, resultado y notas',
  'WOD Type': 'Tipo de WOD',
  'Time / Cap': 'Tiempo / Cap',
  'Score / Result': 'Resultado / Score',
  'WOD Description': 'Descripción del WOD',
  'Notes / Sensations': 'Notas / Sensaciones',
  'Score:': 'Resultado:',
  'Edit workout': 'Editar entrenamiento',
  'Save changes': 'Guardar cambios',
  'Workout name': 'Nombre del entrenamiento',
  'Workout updated': 'Entrenamiento actualizado',
  'Log past workout (quick entry)': 'Registrar entreno pasado (entrada rápida)',
  'Log past workout': 'Registrar entreno pasado',
  'Log workout': 'Registrar entreno',
  'Workout name (optional)': 'Nombre del entrenamiento (opcional)',
  'Strength / Skill Exercises': 'Ejercicios de Fuerza / Skill',
